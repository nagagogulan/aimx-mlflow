...
for name, module in model.named_modules():
    ...
    if layer_type in layer_types:
        ...
        layer_types[layer_type] = 1
pytorch_metrics["layer_types"] = layer_types
...
# If no feature importance was calculated using weights, try a permutation approach
