...
def preprocess_image(image_path, input_size=(224, 224)):
    """Preprocess image for Vision Transformer ONNX model"""
...
# Load ONNX Model
# ----------------------------
print(f"Loading Vision Transformer ({vit_model_size}) ONNX model from: {weight_path}")
try:
...
if mlflowURI:
    ...
    with mlflow.start_run():
        ...
        mlflow.log_param("model_type", f"ViT-{vit_model_size}-ONNX")
