...
def preprocess_image(image_path):
    ...
    preprocess = transforms.Compose([
        transforms.Resize(size=404),  # Resize to slightly larger
        transforms.CenterCrop(size=380),  # Then center crop
        transforms.ToTensor(),
...
def load_model(weight_path):
    """Load EfficientNet-B4 model from .pth file"""
    ...
    print("Falling back to pretrained EfficientNet-B4")
...
if mlflowURI:
    ...
    with mlflow.start_run():
        ...
        mlflow.log_param("model_type", "EfficientNet-B4")
