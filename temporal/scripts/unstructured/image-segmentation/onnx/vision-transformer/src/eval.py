...
def preprocess_image(image_path, input_size=(224, 224)):
    """Preprocess image for ONNX segmentation model with Vision Transformer backbone"""
...
# Load ONNX Model
# ----------------------------
print(f"Loading ONNX Vision Transformer ({vit_model_size}) segmentation model from: {weight_path}")
try:
